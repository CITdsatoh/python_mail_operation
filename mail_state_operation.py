...
class MailDataApplication(tk.Tk):
   ...
   def __init__(self):
     ...
     self.__sub_explaination_label.place(x=32,y=560)
     ...
     self.__all_check_button.place(x=224,y=640)
     ...
     self.__all_de_check_button.place(x=448,y=640)
     ...
     self.__open_original_file_button.place(x=672,y=640)
     ...
     self.__outlook_exe_button.place(x=896,y=640)
     ...
     self.__mail_save_button.place(x=32,y=688)
     ...
     self.__mail_delete_button.place(x=448,y=688)
